...
| Field | Value |
| --- | --- |
| canonical core | `szl-holdings/a11oy/verticals/counsel` |
| kernel | `szl-holdings/a11oy/verticals/_kernel/a11oy_kernel.py` |
| generated Space adapter | `szl-holdings/a11oy/huggingface/spaces` → `SZLHOLDINGS/counsel-assurance` |
...
Informational only. Not legal advice. No automatic filing or client communication.
